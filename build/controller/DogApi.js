...
var DogApi = /** @class */ (function () {
    ...
    DogApi.prototype.ListDogs = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var method, req_1, props, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        method = decoraters_1.Methods.get;
                        req_1 = new FetchClass_1.fetchClass(url, options, method);
                        props = { url: url, options: options, method: method };
